...
const teamPurchase = require("../models/team_purchase");
...
exports.teamPurchase = {
   getTeamPurchase: async (req, res) => {
    try {
      let data = await teamPurchase.aggregate([
        {
          $group: {
            _id: null,
            totalAmount: {
      ...
      return successResponse(res, {
        message: "team purchase get successfully",
        data: data,
      });
    } catch (error) {
      return errorResponse(error, res);
